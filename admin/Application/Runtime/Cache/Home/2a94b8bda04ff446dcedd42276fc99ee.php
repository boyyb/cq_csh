...
<body>
    ...
    <div class="layout_left_menu">
        <ul id="menu">
            <li class="childUlLi">
               <a href=""  target="menuFrame"><i class="glyph-icon icon-home"></i>管理员</a>
                <ul>
                    <li><a href="<?php echo U('admin/index');?>" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>用户添加</a></li>
                </ul>
            </li>
            <li class="childUlLi">
