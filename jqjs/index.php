...
<head>
    ...
    <script src="../public/js/jqjs.js" type="text/javascript"></script>
...
<?php include "../public/common/header.php";?>
    ...
    <div id="jqjs_container">
        <div id="jqjs_left">
            <ul id="accordion" class="accordion">
                <li>
                    <div class="link">景区简介<i class="fa fa-chevron-right"></i></div>
                </li>
                <li>
                    <div class="link">主要景点<i class="fa fa-chevron-right"></i></div>
                </li>
                <li>
                    <div class="link">气候生态<i class="fa fa-chevron-right"></i></div>
                </li>
                <li><div class="link">历史沿革<i class="fa fa-chevron-right"></i></div></li>
                <li><div class="link">交通信息<i class="fa fa-chevron-right"></i></div></li>
                <li><div class="link">其他简介<i class="fa fa-bars"></i></div>
                    <ul class="submenu">
                        <li><a href="javascript:void(0)">总理足迹</a></li>
                        <li><a href="javascript:void(0)">天赐长寿</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <div id="jqjs_right">
            ...
            <div class="jqjs1" style="display:none">
                <h3>主要景点</h3>
                <p>【水立方】：长寿湖由长寿区1江、2湖、3河、13溪做水源补给，形成65平方公里中央湖泊，水资源得天独厚，发展观光旅游、水上运动、生态居所等项目前景广阔。</p>
                <p>【童话岛】：长寿湖湖面辽阔，碧波万顷，203个岛屿星罗棋布、散布其间，是度假、会务、居住的天然王国，也是旅游、休闲项目开发的财富王国。</p>
                <p>【自然界】：长寿湖湖区呈“Y”字型发散，湖汊、内湾众多，岸线蜿蜒曲折、岸线平缓宜人，包含多个原生态自然保护区，在青山绿水间养生，
                    在智力/资金密集型产业园中创造绿色财富，实现湖区经济崛起。</p>
                <p>【风景区】：拥有3000年历史仙逸风骨，200多处文化遗址，300多处游览胜地。包括秦代怀清台遗址、宋代张飞庙、明代东林寺、清代文峰塔，
                    周恩来长寿视察雕塑，及茂林修竹、溶岩龙洞、凛冽矿泉、飞瀑湍流等众多旅游景点。</p>
                <p>【湖区展望】<br/>
                    ...
                    北岸：湖汊、内湾丰富，多岛屿、半岛，亲水性好，向北多缓坡地带，是长寿湖原生态之精华。（规划为智力/资金密集型生态产业公园）</p>
            </div>
            <div class="jqjs2" style="display:none;">
                <h3>气候生态</h3>
                <p>充沛的雨量为各种动植物生长繁衍提供了理想场所。长寿湖内植被以亚热带常绿阔叶林与针叶林为主，主要树种有水杉、银杏、越桂、沙田柚和夏橙等。
                    动物主要以亲水类为主，数量种类繁多。景区内建有野生动物自然保护区，常年栖息鸟类33属、42种，其中水禽28种，数量达15600余只。
                    湖区有国家二级保护动物绿头鸭、风头鸭、斑嘴鸭、秋沙鸭等四种，此外还有天鹅、野鸳鸯等珍稀鸟类。</p>
                <p>长寿湖中大小岛屿203个，星罗棋布，大如山峦，小似弹丸，形状各异。多数植被良好，森林茂密；有的已劈为果园、园林、景点，有的则荒岭秃滩；
                    有的保持原有农田、梯土和植被风光，住有农家、渔舍，或耕耘劳作、或捕鱼种果；还有的已开发建成为旅游景区、景点，设有宾馆、茶社、农家乐及各种游乐设施，
                    供游人赏景、游乐。</p>
            </div>
            <div class="jqjs3" style="display:none;">
                <h3>历史沿革</h3>
                <p>长寿湖因上个世纪50年代人工拦截龙溪河，建设“一五”期间重点水利工程狮子滩水电站而成。重庆市的中部的偏北方向，有一条河流由北而南蜿蜒流过，这便是龙溪河。
            ...
            <div class="jqjs4" style="display:none;">
                <h3>交通信息</h3>
                <p>1.自驾车：<br/>A.从重庆出发，经江北收费站，沿G50沪渝高速公路，在长寿不下高速公路，直接往万州方向行驶，在“长寿湖”路口分道，最后到达长寿湖（狮子滩镇）。全程高速路，整个行程在60分钟左右。
                B.从上海、万州方向出发，沿G50沪渝高速公路，大约在1690公里左右“长寿湖”路口分道，直达长寿湖（狮子滩镇），全程高速路。</p>
                <p>2.交通大巴：<br/>从重庆朝天门或红旗河沟长途汽车站出发，经过江北收费站，沿G50沪渝高速公路，到达长寿骑鞍汽车站，车费30多元。转乘到长寿湖的高速路中巴，直达长寿湖（狮子滩镇），车费约8元。整个行程大约80分钟。</p>
                <div><a class="morezx" style="margin-left:6px;" href="http://localhost/1_csh/public/images/jqjs/dyt.jpg" target="_blank">查看导游地图</a></div>
                <div style="width:650px;height:350px;border:#ccc solid 1px;margin:10px auto" id="dituContent"></div>
            </div>
            <div class="other1" style="display:none;">
                <h3>总理足迹</h3>
                <img src="../public/images/jqjs/zlzj.jpg"/>
                <p>
            ...
            <div class="other2" style="display:none;">
                <h3>天赐长寿</h3>
                <img src="../public/images/jqjs/tccs.jpg"/>
                <p>
...
<script type="text/javascript" src="../public/js/jqjs_baiduMap.js"></script>
</body>
</html>